...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'movie_app_db'),
...
# CORS settings
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://localhost:3001,http://localhost:3002').split(',')
